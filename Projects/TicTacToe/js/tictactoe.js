...
function placeXOrO(squareNumber) {
    ...
    // The .some() method is used to check each element of selectedSquare array to see
    ...
    function computersTurn() {
        ...
        let pickASquare;
        // This condition allows our while loop to keep trying if a square
        // is selected already.
        while(!success) {
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        // The next 3 variables will be used to heck for 3 in a row.
    ...
    function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
        ...
        // This line indicates where the start of a line's y-axis is.
            y1 = coordY1,
        // This line indicates where the end of line's x-axis is.
            x2 = coordX2,
    ...
    function animateLineDrawing() {
        // This variable creates the loop for when the games ends so it restarts.
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y1 < y2) { y += 10; }
            // This condition cancels our animation if end points are reached.
    ...
    // This sound disallows clicking while the win sound is playing.
    disableClick();
